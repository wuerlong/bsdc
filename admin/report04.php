...
if($id>0){
	...
	//print_r($timelist);
	//echo $sttime;
	$orderlist = $db->findAll("select a.* from phpaadb_order a left join phpaadb_member b on a.tel = b.tel  where  a.pickortime >= '".$timelist[0]."' and a.pickortime <= '".$timelist[29]."' and category = '午餐' group by tel order by b.id asc ");
	//print_r($orderlist);
}
    ...
    <td valign="top" style="padding:10px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
        <tr>
          ...
          <td width="300"><select name="select"
					onChange="window.location.href='report04.php?id='+this.value">
...
<option value="2021-01">2021-01</option>
	 <option value="2021-02">2021-02</option>
      ...
      <table width="1500" border="1" align="center" cellpadding="2" cellspacing="0" class="table_form table table-bordered table-striped" id="test_table">
        <tr>
          <td colspan="33" align="center"><?php echo $id;?>月份午餐吃饭汇总名单<br>
          (<?php echo $id?>)
          </td>
        </tr>
